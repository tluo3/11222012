...
\begin{itemize}
    \item[(a)] \verb+[COMMIT]+ Use Sweave to accomplish this
        \begin{itemize}
            \item Use 
\begin{lstlisting}
\includegraphics{nhleeHW3-001}
\end{lstlisting}

\begin{lstlisting}
\includegraphics{nhleeHW3-002}
\end{lstlisting}
...
The eigenvalues of the matrix is ... and ..., which means the number of the eigenvalues is 2.
...
\caption{<YOUR PERFORMANCE EVALUATION> on $100$}
    \label{fig:matlabclownKaNumber}
\end{figure}
\begin{figure}
    \centering
...
\end{Sinput}
\end{Schunk}
\includegraphics{nhleeHW3-012}
\caption{<YOUR PERFORMANCE EVALUATION> on $200$}
    \label{fig:matlabclownKaNumber}
\end{figure}                 
         \end{itemize}
    \item[(b)] 
